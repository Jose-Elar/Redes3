...
class Escena extends Phaser.Scene {
    ...
    create(){
        ...
        const alimentos = [
            this.apple1, this.apple2, this.apple3, this.apple4,
            this.banana1, this.banana2, this.banana3, this.banana4,
            this.burguer1, this.burguer2, this.burguer3, this.burguer4,
            this.coke1, this.coke2, this.coke3, this.coke4,
            this.cookies1, this.cookies2, this.cookies3, this.cookies4,
            this.juice1, this.juice2, this.juice3, this.juice4,
            this.mochi1, this.mochi2, this.mochi3, this.mochi4,
            this.pizza1, this.pizza2, this.pizza3, this.pizza4,
            this.popcorn1, this.popcorn2, this.popcorn3, this.popcorn4,
            this.salad1, this.salad2, this.salad3, this.salad4,
            this.tuna1, this.tuna2, this.tuna3, this.tuna4,
            this.water1, this.water2, this.water3, this.water4,
        ];
    
        alimentos.forEach(alimento => {
            alimento.setInteractive();
    
            alimento.on('pointerdown', function (pointer) {
                this.setTint(0xff0000);
                this.input.dragStartX = this.x - pointer.x;
                this.input.dragStartY = this.y - pointer.y;
                this.scene.children.bringToTop(this);
            });
    
            alimento.on('pointerup', function () {
                this.clearTint();
            });
    
            alimento.on('pointermove', function (pointer) {
                if (pointer.isDown && this.input.dragStartX !== undefined && this.input.dragStartY !== undefined) {
                    this.x = pointer.x + this.input.dragStartX;
                    this.y = pointer.y + this.input.dragStartY;
                }
            });
        });
